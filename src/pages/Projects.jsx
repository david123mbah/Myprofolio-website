...
const projectData = [
  {
     id:1,
      ...
      price: "FLutter",
      detail: " Developed a mobile app using Flutter framework, implementing features such as user authentication and real-time data synchronization for a ridesharing App.",
  ...
  },
  {
      ...
      detail: " Apartment mangement Application where users can login magane Tenants,view house bills payment send notifications to tenants and see occupied and unoccupied room ",
  ...
  },
  {
      ...
      detail: " Restourant app where user can login order for food ,make reservations for tables ,reseives message nofication of their orders and send feedback to app link ",
  ...
  {   
    id: 8,
      ...
      detail: "Worked on group project to reduce a file manager application ,function delete, save ,view documents video and  cloud storage ",
...
const Projects = () => {
  return (
    <>
      <h2>My Projects</h2>
      <div>{ projectData.map((project) => (<ProjectCard key={project.id} title={project.name} discription={project.detail}  imageUrl={project.image} /> ))}</div>
      </>
  )
}
